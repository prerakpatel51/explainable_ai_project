...
gradients.  The sketch model (right) focuses more on the overall \emph{shape}
--- the body outline and silhouette --- because it learned shape-based features
...
edges --- spokes, pedals, and handlebar outlines.  LIME identifies the
...
but the sketch model's attributions are tighter and more shape-focused ---
it highlights the wheel outlines and frame geometry specifically.  The real
...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{Domain shift degrades explanations:}  Classification accuracy
          drops under domain shift, and so does explanation quality ---
          attributions become diffuse, unfocused, and less semantically
          meaningful.

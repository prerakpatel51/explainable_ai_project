...
\centering
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/gradcam/real/ladder_0558.png}
    \caption{Grad-CAM}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/gradcam_pp/real/ladder_0558.png}
    \caption{Grad-CAM++}
\end{subfigure}
...
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/integrated_gradients/real/ladder_0558.png}
    \caption{Integrated Gradients}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/lime/real/ladder_0558.png}
    \caption{LIME}
\end{subfigure}

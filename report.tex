...
the model predicts ``airplane'', the heatmap should highlight the wings and
fuselage rather than the background sky.
...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{Backward pass:} We select the class we want to explain (say,
          ``airplane'') and compute the gradient of its score $y^c$ with
          ...
          would affect the airplane score.  Channels and locations with large
          positive gradients are ``helpful'' for predicting airplane.
    ...
    \item \textbf{Weighted combination + ReLU:} We multiply each feature map
          ...
          For example, if we ask ``why airplane?'', we do not want the
...
class (e.g., a photo of an airplane and a drawing of an airplane), does it
...
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/gradcam/real/airplane_0040.png}
    \caption{Grad-CAM}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/gradcam_pp/real/airplane_0040.png}
    \caption{Grad-CAM++}
\end{subfigure}
...
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/integrated_gradients/real/airplane_0040.png}
    \caption{Integrated Gradients}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/lime/real/airplane_0040.png}
    \caption{LIME}
\end{subfigure}
...
\centering
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/sketch_model/attribution_maps/gradcam/sketch/airplane_0042.png}
    \caption{Grad-CAM}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/sketch_model/attribution_maps/gradcam_pp/sketch/airplane_0042.png}
    \caption{Grad-CAM++}
\end{subfigure}
...
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/sketch_model/attribution_maps/integrated_gradients/sketch/airplane_0042.png}
    \caption{Integrated Gradients}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/sketch_model/attribution_maps/lime/sketch/airplane_0042.png}
    \caption{LIME}
\end{subfigure}
...
\centering
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/gradcam/real/skull_1025.png}
    \caption{Grad-CAM}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/gradcam_pp/real/skull_1025.png}
    \caption{Grad-CAM++}
\end{subfigure}
...
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/integrated_gradients/real/skull_1025.png}
    \caption{Integrated Gradients}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/lime/real/skull_1025.png}
    \caption{LIME}
\end{subfigure}
...
\centering
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/gradcam/sketch/skull_1001.png}
    \caption{Real model --- Grad-CAM}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/sketch_model/attribution_maps/gradcam/sketch/skull_1001.png}
...
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/real_model/attribution_maps/integrated_gradients/sketch/skull_1001.png}
    \caption{Real model --- Integrated Gradients}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{output/xai/sketch_model/attribution_maps/integrated_gradients/sketch/skull_1001.png}
...
\ref{fig:attr_skull_cross}, \ref{fig:attr_tiger_cross}) and the quantitative
